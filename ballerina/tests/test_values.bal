...
// Expected content parts for the generate() tests
...
const map<anydata>[] expectedContentPartsForRateBlog4 = [
    {"text": "Tell me name and the age of the top 10 world class cricketers"}
];

final readonly & map<anydata>[] expectedContentPartsForRateBlog5 = [
    {"text": "How would you rate this blog content out of 10. "},
    {
...
final readonly & map<anydata>[] expectedContentPartsForCountry = [
    {"text": "Which country is known as the pearl of the Indian Ocean?"}
];

// Expected parameter schemas for the getResults tool
